...
declare global {
  ...
  const loadLocale: typeof import('./composables/useI18n')['loadLocale']
  ...
  const performances: typeof import('./composables/options')['performances']
  ...
  const useFormStore: typeof import('./composables/options')['useFormStore']
  ...
  const useTaskStore: typeof import('./composables/task')['useTaskStore']
...
declare module 'vue' {
  interface ComponentCustomProperties {
    ...
    readonly performances: UnwrapRef<typeof import('./composables/options')['performances']>
